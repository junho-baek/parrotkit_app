...
- `src/components/common/CameraShooting.tsx`에서 더 작은 scale 허용 및 drag-to-trash 삭제 추가
- `src/components/common/CameraShooting.tsx`에서 촬영 가이드 선/원 제거
...
- trash/drop 및 guide 제거 이전 상태로 복원
...
- shooting 화면 내부의 `Back` 버튼과 `Prompter` badge를 제거했고, 가이드 선/원도 모두 없앴습니다.
- shooting에서는 cue를 더 작게 줄일 수 있고, 드래그 중 나타나는 trash zone에 놓아 custom cue는 삭제하고 기본 cue는 숨길 수 있게 했습니다.
