...
- 웹 중심 제품이지만, 2026-04-11부터는 `parrotkit-app/`이라는 별도 Expo mobile shell이 생겨 native 강화 가능성이 개념 수준을 넘어 실제 코드베이스로 확장됐다.
- 최근 context 대부분은 recipe detail 단순화와 prompter 상호작용 개선에 집중돼 있다.
