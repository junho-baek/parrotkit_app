...
4. **Environment Variables** 설정:
   ...
   - `LEMONSQUEEZY_API_KEY`: Lemon Squeezy JWT API Key
   - `LEMONSQUEEZY_STORE_ID`: Store ID (282768)
   - `NEXT_PUBLIC_VARIANT_PRO`: Pro 플랜 Variant ID (1263925)
5. **Deploy** 클릭
