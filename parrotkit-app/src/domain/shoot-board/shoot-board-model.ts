...
export type ShootBoardCut = {
  ...
  thumbnailSource?: NativeRecipeImageSource;
  thumbnailUrl: string;
...
type CutDefinition = {
  ...
  referenceThumbnailSource?: NativeRecipeImageSource;
...
const fallbackUgcImages = {
  appDemo: {
    uri: "https://images.unsplash.com/photo-1512428559087-560fa5ceab42?auto=format&fit=crop&w=540&h=960&q=86",
  },
  beautyHero: {
    uri: "https://images.unsplash.com/photo-1524504388940-b1c1722653e1?auto=format&fit=crop&w=540&h=960&q=86",
  },
  beautyResult: {
    uri: "https://images.unsplash.com/photo-1524504388940-b1c1722653e1?auto=format&fit=crop&w=540&h=960&q=86",
  },
  foodPromo: {
    uri: "https://images.unsplash.com/photo-1512621776951-a57141f2eefd?auto=format&fit=crop&w=540&h=960&q=86",
  },
} as const satisfies Record<string, NativeRecipeImageSource>;
...
const koreanDietCutDefinitions: CutDefinition[] = [
  {
    ...
    startSeconds: 0,
    takeThumbnailSource: fallbackUgcImages.beautyHero,
    templateLine:
  ...
  },
  {
    ...
    startSeconds: 5,
    takeThumbnailSource: fallbackUgcImages.beautyResult,
    takeStatus: "saved",
    takes: [
      {
        durationSeconds: 8,
  ...
  },
  {
    ...
    startSeconds: 13,
    takeThumbnailSource: fallbackUgcImages.appDemo,
    templateLine:
