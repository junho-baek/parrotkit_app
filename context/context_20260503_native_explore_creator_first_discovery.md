...
- `parrotkit-app/src/features/explore/screens/explore-screen.tsx`
  ...
  - 추천 카드 정보량을 줄여 긴 설명/저장수/조회수/난이도 라인, source/verification badge, 하단 메타 chips를 제거하고 title, creator, CTA만 남겼다.
  - Explore title 아래 subtitle을 제거해 첫 화면을 검색/카테고리/추천 중심으로 압축했다.
